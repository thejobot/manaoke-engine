// Shared-asset proxy (pitch_data): every song-dir — promoted v0N or random preview
...
// -> "silhouette" -> /songs/_assets/<song>/pitch_data/<path>.
export async function onRequest(context) {
  ...
  url.pathname = `/songs/_assets/${song}/pitch_data/${rest}`;
