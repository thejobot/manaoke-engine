// Shared-asset proxy (images): every song-dir — promoted v0N or random preview
...
// -> "silhouette" -> /songs/_assets/<song>/images/<path>.
export async function onRequest(context) {
  ...
  url.pathname = `/songs/_assets/${song}/images/${rest}`;
